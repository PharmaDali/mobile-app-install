...
function FeatureCard({ icon, title, description, descriptionLine2, className = '' }: FeatureCardProps) {
  return (
    ...
    >
      ...
      <h3 className="text-[#38A5DC] text-base sm:text-xl lg:text-2xl font-bold mb-1.5 sm:mb-2 lg:mb-3 tracking-tight leading-snug">
        {title}
      </h3>
      <p className="text-[#777777] text-[12px] sm:text-[15px] lg:text-[15px] leading-relaxed font-normal">
        {description}
        {descriptionLine2 && (
          <>
